...
function emailOwner(detail, response){
	...
	var mailOptions = {
		...
		"<p>    <strong>Link to share:</strong> http://maxwell.cs.brown.edu:8080/calendar/" + detail[0] + " </p>" + 
	    "<a href='http://maxwell.cs.brown.edu:8080/update/" + encodeURIComponent(detail[1]) +"'> Update your settings </a>" +
